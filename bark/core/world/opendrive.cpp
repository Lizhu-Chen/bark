...
void python_opendrive(py::module m) {
  py::class_<PlanView, std::shared_ptr<PlanView>>(m, "PlanView")
    ...
    .def("GetReferenceLine",
      &PlanView::GetReferenceLine, "Return as numpy array")
    .def("ApplyOffsetTransform",
      &PlanView::ApplyOffsetTransform, "Apply offset to planview");
  ...
  py::class_<XodrRoadLink>(m, "XodrRoadLink")
    .def(py::init<>())
    .def_property("predecessor",
      &XodrRoadLink::GetPredecessor, &XodrRoadLink::SetPredecessor)
    .def_property("successor",
      &XodrRoadLink::GetSuccessor, &XodrRoadLink::SetSuccessor)
    .def(
      "__repr__",
  ...
  py::class_<XodrLane, std::shared_ptr<XodrLane>>(m, "XodrLane")
    ...
    .def_property("lane_position",
      &XodrLane::GetLanePosition, &XodrLane::SetLanePosition)
