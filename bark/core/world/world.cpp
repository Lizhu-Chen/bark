...
#include "bark/core/world/world.hpp"
#include "bark/core/world/agent.hpp"
#include "bark/core/world/map.hpp"
#include "bark/core/world/opendrive.hpp"
#include "bark/core/world/goal_definition.hpp"
#include "bark/core/world/evaluation.hpp"
...
void python_world(py::module m) {
  py::class_<World, std::shared_ptr<World>>(m, "World")
    ...
    .def("__repr__", [](const World& a) {
      return "bark.core.core.world.World";
    });
  ...
  py::class_<ObservedWorld, World, std::shared_ptr<ObservedWorld>>(m, "ObservedWorld")
    ...
    .def("__repr__", [](const ObservedWorld& a) {
      return "bark.core.core.world.ObservedWorld";
    });
